 ...
 *
 * It is similar to DAI if DAI had no governance, no fees, and was back by only WETH and WBTC.
 *
...
contract DSCEngine is ReentrancyGuard {
     ...
     * @notice This function will deposit your collatral and mint DSC in one transaction
     */
        ...
        nonReentrant
    {
        ...
        // 0.05(tokenAmountFormDebtCovered) * 10(Liquidation_bonus) = 0.5 / 100(Liquidatation_Precison) = 0.005 (bonusCollateral)
